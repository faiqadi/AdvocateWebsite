...
export default function TentangKantorSection() {
  return (
    <section
      className="py-24 relative bg-slate-950"
    >
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute right-0 top-0 w-1/3 h-full border-l border-slate-800"></div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <ScrollAnimation direction="left" delay={100}>
            <div className="relative">
              ...
              <div className="bg-slate-900/50 backdrop-blur-sm p-8 border border-slate-800">
                <div className="space-y-6 text-slate-300">
                  <p className="text-lg leading-relaxed">
                    Bagus Law Firm yang sekarang kami menyebut dengan penamaan
                    <span className="font-bold text-white"> BAGUS LAW</span> merupakan salah satu firma hukum yang berbentuk badan hukum
          ...
          <ScrollAnimation direction="right" delay={200}>
            <div className="space-y-8">
              {/* Vision Card */}
              <div className="group bg-slate-900 border border-slate-800 p-8 hover:border-accent/50 transition-colors duration-300">
                <div className="flex items-start justify-between mb-4">
                  <h3 className="text-2xl font-bold text-white uppercase">Visi</h3>
                  <span className="text-4xl text-slate-800 font-bold group-hover:text-accent/20 transition-colors">01</span>
                </div>
              ...
              <div className="group bg-slate-900 border border-slate-800 p-8 hover:border-accent/50 transition-colors duration-300">
                <div className="flex items-start justify-between mb-4">
                  <h3 className="text-2xl font-bold text-white uppercase">Misi</h3>
                  <span className="text-4xl text-slate-800 font-bold group-hover:text-accent/20 transition-colors">02</span>
                </div>
                <p className="text-slate-400">
