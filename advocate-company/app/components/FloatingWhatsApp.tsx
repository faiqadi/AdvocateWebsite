  ...
  return (
    ...
    >
      <div className="relative">
        {/* Tooltip */}
        {isHovered && (
          <div className="absolute right-full mr-4 top-1/2 transform -translate-y-1/2 whitespace-nowrap bg-gray-900 text-white text-sm px-4 py-2 rounded-lg shadow-lg">
            Chat dengan kami
